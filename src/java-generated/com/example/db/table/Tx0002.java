...
public class Tx0002 {
	 ...
	 * テーブルクラスの唯一のインスタンス
	 */	
	private static final Tx0002Impl instance = new Tx0002Impl();

	/**
	 * テーブルクラスの唯一のインスタンスを取得する。
	 */
	private static Tx0002Impl getInstance() {
		return instance;
	}
     ...
     * テーブルクラスの実装
     */	
	private static class Tx0002Impl extends Table<Tx0002.Row> {
		...
		protected Table.TableMetaData getTableMetaData() {
			return new Table.TableMetaData("DB2ADMIN", "TX0002");
		}
		...
		protected Table.ColumnMetaData[] getColumnMetaData() {
		 	return new Table.ColumnMetaData[]{
				...
				new Table.ColumnMetaData("COL1_1", "col11", java.lang.String.class, true),
